...
import static atto.container.ComponentContainer.cardService;

public class UserController {
    public static void userCardMenu() {
    ...
    public static void userByCardStart() {
        boolean bool = true;
        while (bool) {
    ...
    public static void addCard() {
        ...
        ComponentContainer.userService.addCard(card);
    }
